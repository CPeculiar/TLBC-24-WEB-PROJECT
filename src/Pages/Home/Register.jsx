...
const Register = () => {
  ...
  const validateForm = (data) => {
    ...
    if (campingStatus === "Daily" && !data.attendance_mode) {
      newErrors.attendance_mode =
        "Please select how you will join the Convocation";
      isValid = false;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.email || data.phone) {
          ...
          if (data.phone) {
            errorMessage += "Phone error: " + data.phone[0];
          }
          alert(errorMessage);
        } else {
          ...
          <div className="">
            <div className="col-12 mt-4 mb-5 text-center">
              ...
              <p className="text-white">
                Kindly fill the registration form below if you have not done so
                already. <br />
          ...
          <form id="registration-form" method="post" onSubmit={handleSubmit}>
            ...
            <div className="form-group birth-date">
              ...
              <input
                ...
                onChange={handleInputChange}
              />
              <span className="error" id="date-error">
                {errors.birthdate}
              </span>
            </div>
            <div className="form-group phone-number">
              ...
              <input
                ...
                onChange={handleInputChange}
              />
              <span className="error" id="number-error">
                {errors.phone}
              </span>
            </div>
            ...
            <div className="form-group membership-status">
              <label htmlFor="member">
                Are you a member of The Lord's Brethren Church International?
              </label>
              <select
                id="member"
                name="category"
              ...
              <span className="error" id="member-error">
                {errors.category}
              </span>
            </div>
            {memberStatus === "Member" && (
              <div className="form-group your-zone" id="is-member">
                <label htmlFor="churchZone">
                ...
                <span className="error" id="churchZone-error">
                  {errors.church_name}
                </span>
              </div>
            )}
            {memberStatus === "Invitee" && (
              <div className="form-group name-of-church" id="not-member">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                />
                <span className="error" id="churchname-error">
                  {errors.church_name}
                </span>
              </div>
            )}
            <div className="form-group are-you-aware">
              ...
              <span className="error" id="areYouAware-error">
            ...
            <div className="form-group are-you-camping">
              ...
              >
                ...
                <option value="Daily">No</option>
              </select>
              <span className="error" id="areYouCamping-error">
                {errors.attendance_mode}
              </span>
            </div>
            {campingStatus === "Daily" && (
              <div className="form-group how-to-join" id="dailyOrStreamDiv">
                <label htmlFor="dailyOrStream">
                ...
                <span className="error" id="dailyOrStream-error">
                  {errors.attendance_mode}
                </span>
              </div>
            )}
            <div className="form-group was-participant">
              ...
              <span className="error" id="haveyouAttendedBefore-error">
            ...
            <div className="form-group health-condition">
              ...
              <span className="error" id="anyHealthCondition-error">
                {errors.health_issue}
              </span>
            </div>
            {healthCondition === "true" && (
              <div
                className="form-group health-condition"
                id="yourHealthConditionDiv"
              >
                <label htmlFor="yourHealthCondition">
                  Tell us about the condition briefly
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleInputChange}
                />
                <span className="error" id="yourHealthCondition-error">
                  {errors.health_issue}
                </span>
              </div>
            )}
